...
class ConfigListView(GenericViewSet):
    """
    版本提测增删改查
    """
    queryset = models.SitConfigList.objects.all()
    serializer_class = serializers.SitConfigListSerializer
    ...
    def modify(self, request, **kwargs):
        ...
        configList = json_data['configList']
        i=0
        ...
        engine = create_engine(
            ...
            encoding='utf-8')
        con = engine.connect()
        result.to_sql(name='version_release_sitconfiglist', con=con, if_exists='append', index=False)

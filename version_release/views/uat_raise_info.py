...
class UatRaiseInfoView(GenericViewSet):
    """
    uat版本提测增删改查
    """
    queryset = models.UatRaiseInfo.objects.all()
    serializer_class = serializers.UatRaiseInfoSerializer
    ...
    def list(self, request):
        ...
        if keyword != '':
            ...
            projects_fileter = projects_fileters.filter(
    ...
    def add(self, request):
        ...
        # 反序列化
        serializer = serializers.UatRaiseInfoSerializer(data=request.data)
